...
#DRIVE_TRAIN_TYPE = "PSOC_I2C_PWM"
DRIVE_TRAIN_TYPE = "PIGPIO_PWM"

# #STEERING FOR PIGPIO_PWM
STEERING_PWM_PIN = 12           #Pin numbering according to Broadcom numbers
STEERING_PWM_FREQ = 100         #Frequency for PWM
STEERING_PWM_INVERTED = False   #If PWM needs to be inverted
STEERING_CENTER_PWM = 1490      #usec
STEERING_LEFT_PWM = (STEERING_CENTER_PWM-290) #430)
STEERING_RIGHT_PWM = (STEERING_CENTER_PWM+290) #430)

# #THROTTLE FOR PIGPIO_PWM
THROTTLE_PWM_PIN = 13           #Pin numbering according to Broadcom numbers
THROTTLE_PWM_FREQ = 100         #Frequency for PWM
THROTTLE_PWM_INVERTED = False   #If PWM needs to be inverted
THROTTLE_STOPPED_PWM = 1520     #usec
THROTTLE_FORWARD_PWM = (THROTTLE_STOPPED_PWM+430)
THROTTLE_REVERSE_PWM = (THROTTLE_STOPPED_PWM-430)

# #LIDAR FOR PIGPIO_PWM
LIDAR_PWM_PIN = 19              #Pin numbering according to Broadcom numbers
LIDAR_PWM_FREQ = 100            #Frequency for PWM
LIDAR_PWM_INVERTED = True       #If PWM needs to be inverted
LIDAR_CENTER_PWM = 1490         #usec
LIDAR_LEFT_PWM = (LIDAR_CENTER_PWM-430)
LIDAR_RIGHT_PWM = (LIDAR_CENTER_PWM+430)
